...
public class Manager {
    ...
    public Notification schedule (Options options) {
        Log.d(Notification.LOG_TAG, "Manager schedule");
    ...
    /**
     * Clear all the local notifications which are triggered
     */
    public void clearTriggeredNotifications () {
        List<Notification> notifications = getAll();
        Log.d(Notification.LOG_TAG, "clearTriggeredNotifications");
        for (Notification notification : notifications) {
            notification.clearTriggered();
        }
    }
    ...
    private SharedPreferences getPrefs () {
        return context.getSharedPreferences(Notification.PREF_KEY, Context.MODE_PRIVATE);
    }
