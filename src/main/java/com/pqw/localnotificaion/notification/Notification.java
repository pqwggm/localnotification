...
public class Notification {
    public static final String LOG_TAG = "pqw_local_notification";
     ...
     * @param needPersist 是否保存到本地（对于手机重启之后再次开启推送，是不需要保存到本地的）
     */
    public void schedule(boolean needPersist) {
        Log.d(LOG_TAG, "notification schedule start");
        ...
        if (isRepeating()) {
            ...
            Log.d(LOG_TAG, "triggerTime is: " + triggerTime + "; currentTimeMillis: " + System.currentTimeMillis() + "; Interval: " + options.getRepeatInterval());
        } else {
    ...
    private void persist () {
        Log.d(LOG_TAG, "persist id: " + options.getIdStr() + "options: " + options.toString());
    ...
    private void unpersist () {
        Log.d(LOG_TAG, "unpersist id: " + options.getIdStr());
        SharedPreferences.Editor editor = getPrefs().edit();
